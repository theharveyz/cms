# GPU监控数据查询 {#concept_ysn_byq_32b .concept}
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15305/6694_zh-CN.jpeg)
...
5.  在刷新的页面中，单击**添加图表**。
6.  在**添加图表**页面，选择您需要的图表类型，然后选择**云产品监控** \> **云服务器ECS** \> **GPU**，如下图所示。
...
-   详见[https://help.aliyun.com/document\_detail/51936.html](https://help.aliyun.com/document_detail/51936.html)
-   参数说明：Project=acs\_ecs\_dashboard,Metric及Dimensions参考上述表格中的GPU指标。
