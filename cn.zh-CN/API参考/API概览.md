...
## 云产品时序指标类监控数据 {#section_h7p_phf_owp .section}
...
## 报警联系人组 {#section_t4w_dld_oil .section}
...
## 时序指标报警规则 {#section_ve5_ueo_ixs .section}

|API|描述|
|---|--|
|[ListContactGroup](intl.zh-CN/API参考/时序指标报警规则/ListContactGroup.md)|查询云账号下对应的报警规则联系人组。|
|[DescribeProductsOfActiveMetricRule](intl.zh-CN/API参考/时序指标报警规则/DescribeProductsOfActiveMetricRule.md)|查询开通一键告警产品列表。|
|[EnableActiveMetricRule](intl.zh-CN/API参考/时序指标报警规则/EnableActiveMetricRule.md)|启用一键报警产品。|
|[DescribeActiveMetricRuleList](intl.zh-CN/API参考/时序指标报警规则/DescribeActiveMetricRuleList.md)|显示一键报警规则的列表详情。|
...
## 主机监控 {#section_yff_b2e_ovz .section}
...
|[DescribeMonitoringAgentHosts](intl.zh-CN/API参考/主机监控/DescribeMonitoringAgentHosts.md)|获取安装云监控插件的主机列表。|
...
## 应用分组 {#section_pce_irz_urq .section}
...
## 可用性监控 {#section_hl2_p6d_kgn .section}
...
## 全局配置 {#section_btp_fdm_f2t .section}
...
## 云产品事件类监控数据 {#section_kbv_jho_3ox .section}
...
## 时序指标报警模板 {#section_cfm_efy_m9p .section}
...
## 事件报警规则 {#section_bko_avd_r8p .section}
...
## 自定义监控 {#section_25o_fig_udd .section}
...
## 自定义事件 {#section_7ky_rgi_k8d .section}
...
## 站点监控 {#section_suw_wlh_dqf .section}
