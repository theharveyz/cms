...
您可以实时了解各云服务的资源保有、使用水位和报警情况。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6123/156040900934450_zh-CN.png)
...
云服务器 ECS的CPU、内存、磁盘使用率数据需要安装云监控插件才能采集。插件安装方法请参考[云监控Go语言版本插件安装](../../../../cn.zh-CN/用户指南/主机监控/云监控Go语言版本插件安装.md#)。
