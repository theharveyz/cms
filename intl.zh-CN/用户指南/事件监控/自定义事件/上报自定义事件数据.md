...
-   **准备工作** 
    ...
    1.  创建子账号。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6163/156108823121800_zh-CN.png)

    2.  为子账号生成accesskeyid， accesskeysecrret。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6163/156108823121804_zh-CN.png)

    3.  为子账号授权云监控权限。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6163/156108823121812_zh-CN.png)
...
-   **子账号授权说明** 
    ...
    3.  选择需要上报数据的子账号，在操作中单击**添加权限** 。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6163/156108823221813_zh-CN.png)

    4.  在添加权限页面中，选择**管理云监控的权限**，并单击**确定**保存授权。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6163/156108823221815_zh-CN.png)
